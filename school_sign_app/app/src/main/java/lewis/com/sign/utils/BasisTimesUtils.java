...
public class BasisTimesUtils {
     ...
     * 将字符串时间转为Long时间
     *
     * @param time yyyy-MM-dd HH:mm:FaceResult:SSS
     */
    public static Long getLongTimeOfSSS(String time) {
        try {
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:FaceResult:SSS");
     ...
     * 将字符串时间转为Long时间
     *
     * @param time yyyy-MM-dd HH:mm:FaceResult
     */
    public static Long getLongTime(String time) {
        try {
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:FaceResult");
            Date date = sdf.parse(time);
            return date.getTime();
        } catch (Exception e) {
        }
     ...
     * 将Long时间转成String时间
     *
     * @return yyyy-MM-dd HH:mm:FaceResult:SSS
     */
     ...
     * 将Long时间转成String时间
     *
     * @return yyyy-MM-dd HH:mm:FaceResult
     */
    ...
    public static String getDeviceTimeOfSSS() {
        String date = "";
        try {
            SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:FaceResult:SSS");
    ...
    public static String getDeviceTime() {
        String date = "";
        try {
            SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:FaceResult");
            date = df.format(new Date());
        } catch (Exception e) {
            e.printStackTrace();
            date = new Date().getTime() + "";//当前时间的long字符串
